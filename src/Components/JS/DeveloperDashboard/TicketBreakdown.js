...
export default function TicketBreakdown() {
    ...
    location.pathname === "/maindash"
        ? URL = `https://drf-react-ticketing-backend.herokuapp.com/api/dev-ticket-breakdown/${localStorage.getItem('id')}/`
        : URL = 'https://drf-react-ticketing-backend.herokuapp.com/api/all-ticket-breakdown/'
